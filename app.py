...
st.markdown("""
Esta aplicación corrija automáticamente los exámenes 📄  
usando *Google Gemini 1.5* y un flujo en **n8n (/examenes-calificar)**.  
> ⚙️ Todo el procesamiento es funcional.
""")
